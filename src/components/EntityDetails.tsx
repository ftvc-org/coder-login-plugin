...
import { Loader, Button } from "@cortexapps/react-plugin-ui";
...
const EntityDetails: React.FC = () => {
  ...
  const { isLoading: isCustomEventsLoading } =
    useEntityCustomEvents({ entityTag });

  const isLoading =
    isEntityLoading || isCustomEventsLoading;

  // Calculate coderUrl
  const getCoderUrl = (): string => {
